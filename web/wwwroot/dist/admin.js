...
var ContactIndex = /** @class */ (function () {
    function ContactIndex(_service, translate, _modalService, _toasterService) {
        this._service = _service;
        this.translate = translate;
    ...
    ContactIndex = __decorate([
        ...
        __metadata("design:paramtypes", [ContactService_1.ContactService, ng2_translate_1.TranslateService, ng_bootstrap_1.NgbModal, angular2_toaster_1.ToasterService])
    ], ContactIndex);
    return ContactIndex;
}());
...
module.exports = __webpack_require__("./ClientApp/app/admin/admin.module.ts");
